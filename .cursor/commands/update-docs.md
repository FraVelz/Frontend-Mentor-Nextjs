...
1. **Enlace bilingüe** justo tras el `#` del título: en `README.md` → «English version» hacia `./README.en.md`; en el inglés, la cabecera debe incluir: `This document is in English. [Versión en español](./README.md)`.
