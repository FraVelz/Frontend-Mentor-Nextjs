export function SiteFooter() {
  ...
  return (
    <footer className="mt-auto border-t border-white/10 bg-slate-950/80 backdrop-blur-sm">
      <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-10 sm:px-6 sm:py-12 lg:px-8 lg:flex-row lg:items-start lg:justify-between lg:gap-10">
        <div className="max-w-md">
          <p className="text-sm font-semibold text-slate-200">(FV) Fravelz</p>
          <p className="mt-2 text-sm leading-relaxed text-slate-400">
            Versión Next.js de la colección de retos. Pensada para practicar App Router, componentes y
            despliegues más cercanos a un entorno profesional.
          </p>
        </div>
        <nav aria-label="Enlaces">
          ...
          <ul className="mt-3 flex list-none flex-col gap-2 text-sm [&>li]:m-0 [&>li]:p-0">
            <li>
              <a
                className="text-slate-300 transition hover:text-sky-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-400"
