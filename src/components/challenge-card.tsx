...
export function ChallengeCard({ challenge }: { challenge: Challenge }) {
  return (
    <li>
      <a
        href={challenge.fmUrl}
        target="_blank"
        rel="noopener noreferrer"
        className="group flex h-full flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/[0.06] shadow-[0_4px_24px_rgba(0,0,0,0.35)] backdrop-blur-md transition duration-200 hover:border-sky-400/35 hover:bg-white/[0.09] hover:shadow-[0_0_0_1px_rgba(56,189,248,0.12),0_16px_48px_rgba(0,0,0,0.35)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-400 motion-safe:hover:-translate-y-0.5 motion-reduce:transition-none motion-reduce:hover:translate-y-0"
      >
        <div
        ...
        <div className="flex flex-1 flex-col gap-3 p-4 sm:p-5">
          <div className="flex flex-wrap items-center gap-2">
            <span
              className={`inline-flex items-center rounded-md px-2 py-0.5 text-[0.65rem] font-semibold uppercase tracking-wide ring-1 ring-inset ${difficultyStyles[challenge.difficulty]}`}
            >
              {difficultyLabels[challenge.difficulty]}
            </span>
            <span
              className={`inline-flex items-center rounded-md px-2 py-0.5 text-[0.65rem] font-medium ring-1 ring-inset ${statusStyles[challenge.status]}`}
            >
          ...
          <div className="flex flex-1 items-start justify-between gap-3">
            ...
            <span
              className="flex h-10 w-10 shrink-0 items-center justify-center self-start rounded-lg bg-sky-500/15 text-sky-400 transition motion-safe:group-hover:translate-x-0.5 motion-safe:group-hover:bg-sky-500/25 motion-reduce:group-hover:translate-x-0"
              aria-hidden
            >
              <svg
                className="h-4 w-4"
