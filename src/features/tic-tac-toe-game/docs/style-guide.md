...
- Breakpoints: **tablet** desde `48rem` (768px), **desktop** `90rem`, definidos en `@theme` junto al resto del monorepo
  (`style.css`).
...
- Sombra inferior de bloques (tipo “inset”): `#10212a` en tablero y panel; `#6b8997` en botón reinicio; sombras de
  pulsación de botones `#cc8b13`, `#118c87` según componente.
