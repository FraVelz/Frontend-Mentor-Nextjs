...
export function GameHeader() {
  ...
  return (
    <header className="grid w-full grid-cols-3 items-center gap-5">
      ...
      <div
        className="
          flex h-10 items-center justify-center gap-3 rounded-md bg-slate-800 text-center text-[14px] leading-[130%] font-bold tracking-[0.9px] uppercase shadow-[inset_0_-4px_0_#10212A]
      ...
      <button
        ...
        className="flex h-10 w-10 cursor-pointer items-center justify-center justify-self-end rounded-md bg-slate-300 shadow-[inset_0_-4px_0_#6B8997] transition-all hover:bg-slate-100 tablet:h-[52px] tablet:w-[52px]"
      >
