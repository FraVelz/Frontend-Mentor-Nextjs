...
- Cálculo de **IMC**, clasificación (bajo peso / peso saludable / sobrepeso / obesidad) y **rango de peso ideal**
...
- Captura para tarjeta y OG/Twitter versionada en
  [`public/bmi-calculator/screenshot.png`](../../../public/bmi-calculator/screenshot.png) (viewport de referencia;
  puedes regenerarla desde tu deploy).
