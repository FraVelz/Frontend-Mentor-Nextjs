...
- Presets de texto en `style.css`: `text-preset-1` … `text-preset-7-regular` (tamaños, pesos y `letter-spacing` del
  diseño FM).
...
- Iconos y patrones SVG en [`../images/`](../images/); favicon FM en
