...
export function ResultsSection() {
  return (
    <section
      className={cn(
        "tablet:flex-row tablet:gap-[4.5rem] tablet:px-10 relative flex flex-col items-center gap-12 px-6",
    ...
    >
      <Image
        ...
        width={85}
        height={150}
        className="desktop:block absolute top-0 right-44 hidden"
        aria-hidden
      />

      <div
        className={cn(
          "tablet:max-w-[27.2rem] relative aspect-[565/412] w-full max-w-[21.5rem] shrink-0",
      ...
      <div className="tablet:px-0 desktop:translate-y-16 flex max-w-xl flex-col gap-8">
        <h2
          className={cn(
        ...
        <p className="text-var-grey-500 text-preset-6-regular">
          ...
          your chances of experiencing health issues later on, such as obesity and type 2 diabetes. Aim for a nutritious
