...
export function TipsSection() {
  return (
    <section
      className={cn(
        "flex flex-col gap-10 bg-gradient-to-r from-white to-[rgba(214,230,254,0.3)] px-6 py-12",
        "tablet:px-10 tablet:py-12 desktop:grid desktop:grid-cols-3 desktop:gap-8 desktop:px-32 desktop:py-24",
      )}
    >
      {TIPS.map((tip) => (
